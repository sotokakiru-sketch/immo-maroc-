  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end gap-3">
      ...
      <a
        ...
        aria-label="Contacter Immo Maroc sur WhatsApp — 07 71 52 19 69"
        className="group flex items-center gap-3"
      >
        <span className="hidden rounded-full bg-brand-950/90 px-4 py-2 text-sm font-medium text-white shadow-luxe backdrop-blur sm:block">
          {AGENCY.phoneDisplay2}
        </span>
        <span className="grid h-11 w-11 place-items-center rounded-full bg-[#25D366] text-white shadow-luxe transition-transform group-hover:scale-110">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contacter Immo Maroc sur WhatsApp"
        className="group flex items-center gap-3"
      >
        <span className="hidden rounded-full bg-brand-950/90 px-4 py-2 text-sm font-medium text-white shadow-luxe backdrop-blur sm:block">
        ...
        <span className="relative grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-luxe transition-transform group-hover:scale-110">
          ...
          <WhatsAppSvg className="relative h-7 w-7" />
        </span>
      </a>
    </div>
  );
